...
extension SteamControllerParser {
  ...
  public func hidStartupFeatureReports() -> [PhysicalHIDOutputReport] {
    [
      steamFeatureReport(steamControllerClearDigitalMappingsPayload),
      steamFeatureReport(steamControllerLizardModePayload),
    ]
  }

  public func hidShutdownFeatureReports() -> [PhysicalHIDOutputReport] {
    [
      steamFeatureReport(steamControllerDefaultDigitalMappingsPayload),
      steamFeatureReport(steamControllerLoadDefaultSettingsPayload),
    ]
  }
