...
struct RemappingChordPriorityTests {
  @Test
  func largerChordReleasesSmallerOverlappingOutputBeforePress() {
  ...
  @Test
  func equalSpecificityUsesProfileOrder() {
    var state = RemappingEngineState()
    let profile = profile(chords: [
  ...
  @Test
  func disjointChordsCanRemainActiveTogether() {
    var state = RemappingEngineState()
    let profile = profile(chords: [
  ...
  @Test
  func latestLayerOverridesIdenticalChordSources() {
    var state = RemappingEngineState()
    let profile = profile(
  ...
  private func chord(_ buttons: Set<RemappingButton>, key: RemappingKeyboardKey) -> RemappingChord {
    RemappingChord(
  ...
  private func profile(chords: [RemappingChord], layers: [RemappingLayer] = []) -> RemappingProfile
  {
    RemappingProfile(
      name: "Chord priority",
